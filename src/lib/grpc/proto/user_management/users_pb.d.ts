...
export class UserProfile extends jspb.Message {
  ...
  getProfilePicturePresignedUrl(): string;
  setProfilePicturePresignedUrl(value: string): UserProfile;
...
export class VolunteerDetails extends jspb.Message {
  ...
  getSafeguardCertificateUrl(): string;
  setSafeguardCertificateUrl(value: string): VolunteerDetails;
...
export namespace VolunteerDetails {
  export type AsObject = {
    role: string,
    graduateyear: number,
    safeguardCertificateUrl: string,
...
export class UpdateAdminProfileRequest extends jspb.Message {
  ...
  getProfilePictureUrl(): string;
  setProfilePictureUrl(value: string): UpdateAdminProfileRequest;
...
export class UpdateAdminProfileResponse extends jspb.Message {
  ...
  getProfilePicturePresignedUrl(): string;
  setProfilePicturePresignedUrl(value: string): UpdateAdminProfileResponse;
...
export class UpdateSchoolProfileRequest extends jspb.Message {
  ...
  getProfilePictureUrl(): string;
  setProfilePictureUrl(value: string): UpdateSchoolProfileRequest;
...
export class UpdateSchoolProfileResponse extends jspb.Message {
  ...
  getProfilePicturePresignedUrl(): string;
  setProfilePicturePresignedUrl(value: string): UpdateSchoolProfileResponse;
...
export class UpdateStudentProfileRequest extends jspb.Message {
  ...
  getProfilePictureUrl(): string;
  setProfilePictureUrl(value: string): UpdateStudentProfileRequest;
...
export class UpdateStudentProfileResponse extends jspb.Message {
  ...
  getProfilePicturePresignedUrl(): string;
  setProfilePicturePresignedUrl(value: string): UpdateStudentProfileResponse;
...
export class UpdateVolunteerProfileRequest extends jspb.Message {
  ...
  getProfilePictureUrl(): string;
  setProfilePictureUrl(value: string): UpdateVolunteerProfileRequest;

  getSafeguardCertificateUrl(): string;
  setSafeguardCertificateUrl(value: string): UpdateVolunteerProfileRequest;
...
export class UpdateVolunteerProfileResponse extends jspb.Message {
  ...
  getProfilePicturePresignedUrl(): string;
  setProfilePicturePresignedUrl(value: string): UpdateVolunteerProfileResponse;

  getSafeguardCertificatePresignedUrl(): string;
  setSafeguardCertificatePresignedUrl(value: string): UpdateVolunteerProfileResponse;
...
export namespace UpdateVolunteerProfileResponse {
  export type AsObject = {
    ...
    message: string,
    profilePicturePresignedUrl: string,
    safeguardCertificatePresignedUrl: string,
  }
}
...
export class Volunteer extends jspb.Message {
  ...
  getSafeguardCertificateUrl(): string;
  setSafeguardCertificateUrl(value: string): Volunteer;
