...
export class DebateServiceClient {
  ...
  methodDescriptorSetRankingVisibility = new grpcWeb.MethodDescriptor(
    '/debate_management.DebateService/SetRankingVisibility',
    grpcWeb.MethodType.UNARY,
    debate_management_debate_pb.SetRankingVisibilityRequest,
    debate_management_debate_pb.SetRankingVisibilityResponse,
    (request: debate_management_debate_pb.SetRankingVisibilityRequest) => {
      return request.serializeBinary();
    },
    debate_management_debate_pb.SetRankingVisibilityResponse.deserializeBinary
  );

  setRankingVisibility(
    request: debate_management_debate_pb.SetRankingVisibilityRequest,
    metadata?: grpcWeb.Metadata | null): Promise<debate_management_debate_pb.SetRankingVisibilityResponse>;

  setRankingVisibility(
    request: debate_management_debate_pb.SetRankingVisibilityRequest,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError,
               response: debate_management_debate_pb.SetRankingVisibilityResponse) => void): grpcWeb.ClientReadableStream<debate_management_debate_pb.SetRankingVisibilityResponse>;

  setRankingVisibility(
    request: debate_management_debate_pb.SetRankingVisibilityRequest,
    metadata?: grpcWeb.Metadata | null,
    callback?: (err: grpcWeb.RpcError,
               response: debate_management_debate_pb.SetRankingVisibilityResponse) => void) {
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ +
          '/debate_management.DebateService/SetRankingVisibility',
        request,
        metadata || {},
        this.methodDescriptorSetRankingVisibility,
        callback);
    }
    return this.client_.unaryCall(
    this.hostname_ +
