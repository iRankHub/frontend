...
export namespace auth {
    ...
    export class EnableTwoFactorResponse extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            ...
            if (!Array.isArray(data) && typeof data == "object") {
                ...
                if ("qrCode" in data && data.qrCode != undefined) {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.secret.length)
                writer.writeString(1, this.secret);
            if (this.qrCode.length)
                writer.writeString(2, this.qrCode);
            if (!w)
                return writer.getResultBuffer();
        }
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        message.qrCode = reader.readString();
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class VerifyTwoFactorResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            success?: boolean;
        }) {
        ...
        static fromObject(data: {
            ...
            const message = new VerifyTwoFactorResponse({});
            if (data.success != null) {
                message.success = data.success;
            }
            return message;
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): VerifyTwoFactorResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new VerifyTwoFactorResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
        ...
        static deserializeBinary(bytes: Uint8Array): VerifyTwoFactorResponse {
            return VerifyTwoFactorResponse.deserialize(bytes);
        }
    }
    ...
    export abstract class UnimplementedAuthServiceService {
        static definition = {
            ...
            VerifyTwoFactor: {
                ...
                responseSerialize: (message: VerifyTwoFactorResponse) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => VerifyTwoFactorResponse.deserialize(new Uint8Array(bytes))
            },
            DisableTwoFactor: {
        ...
        abstract VerifyTwoFactor(call: grpc_1.ServerUnaryCall<VerifyTwoFactorRequest, VerifyTwoFactorResponse>, callback: grpc_1.sendUnaryData<VerifyTwoFactorResponse>): void;
    ...
    export class AuthServiceClient extends grpc_1.makeGenericClientConstructor(UnimplementedAuthServiceService.definition, "AuthService", {}) {
        ...
        VerifyTwoFactor: GrpcUnaryServiceInterface<VerifyTwoFactorRequest, VerifyTwoFactorResponse> = (message: VerifyTwoFactorRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<VerifyTwoFactorResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<VerifyTwoFactorResponse>, callback?: grpc_1.requestCallback<VerifyTwoFactorResponse>): grpc_1.ClientUnaryCall => {
