...
export class AuthServiceClient {
  ...
  methodDescriptorVerifyTwoFactor = new grpcWeb.MethodDescriptor(
    ...
    authentication_auth_pb.VerifyTwoFactorResponse,
    (request: authentication_auth_pb.VerifyTwoFactorRequest) => {
      return request.serializeBinary();
    },
    authentication_auth_pb.VerifyTwoFactorResponse.deserializeBinary
  );

  verifyTwoFactor(
    request: authentication_auth_pb.VerifyTwoFactorRequest,
    metadata?: grpcWeb.Metadata | null): Promise<authentication_auth_pb.VerifyTwoFactorResponse>;

  verifyTwoFactor(
    request: authentication_auth_pb.VerifyTwoFactorRequest,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError,
               response: authentication_auth_pb.VerifyTwoFactorResponse) => void): grpcWeb.ClientReadableStream<authentication_auth_pb.VerifyTwoFactorResponse>;

  verifyTwoFactor(
    request: authentication_auth_pb.VerifyTwoFactorRequest,
    metadata?: grpcWeb.Metadata | null,
    callback?: (err: grpcWeb.RpcError,
               response: authentication_auth_pb.VerifyTwoFactorResponse) => void) {
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ +
          '/auth.AuthService/VerifyTwoFactor',
