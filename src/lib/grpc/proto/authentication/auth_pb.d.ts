...
export class UserData extends jspb.Message {
  ...
  getSafeguardingCertificateUrl(): string;
  setSafeguardingCertificateUrl(value: string): UserData;
...
export namespace UserData {
  export type AsObject = {
    ...
    nationalid: string,
    safeguardingCertificateUrl: string,
    grade: string,
...
export class SignUpRequest extends jspb.Message {
  ...
  getSafeguardingCertificateUrl(): string;
  setSafeguardingCertificateUrl(value: string): SignUpRequest;
