...
const Page = withAuth(
  ({ params }: Iparms) => {
    return <SchoolTournamentTeamsPage params={params} />;
  },
  [Roles.SCHOOL]
);

function SchoolTournamentTeamsPage({ params }: Iparms) {
      ...
      <div className="w-full flex flex-col md:flex-row md:items-center justify-between gap-2 md:gap-5">
        ...
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbItem>
              <BreadcrumbLink href="/schools/tournaments" className="text-muted-foreground text-base">
                Tournament
              </BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator>
