...
import Judges from "@/components/pages/schools/tournaments/tournament-name/judges";
...
const Page = withAuth(
  ({ params }: Iparms) => {
    return <SchoolTournamentJudgesPage params={params} />;
  },
  [Roles.SCHOOL]
);

function SchoolTournamentJudgesPage({ params }: Iparms) {
