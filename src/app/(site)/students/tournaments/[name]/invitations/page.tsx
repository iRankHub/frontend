...
const Page = withAuth(
  ({ params }: Iparms) => {
    return <StudentTournamentInvitationsPage params={params} />;
  },
  [Roles.STUDENT]
);

function StudentTournamentInvitationsPage({ params }: Iparms) {
    ...
    <ContentLayout title="format">
      <div className="w-full flex items-center justify-between gap-5">
        ...
        <Breadcrumb>
          <BreadcrumbList>
            <BreadcrumbItem>
              <BreadcrumbLink href="/students/dashboard" className="text-muted-foreground text-base">
                Students
              </BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator>
            ...
            <BreadcrumbItem>
              <BreadcrumbLink href="/students/tournaments/list" className="text-muted-foreground text-base">
                Tournament
              </BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator>
