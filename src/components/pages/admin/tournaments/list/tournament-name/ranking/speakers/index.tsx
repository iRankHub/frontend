...
import { DataTable } from "@/app/(site)/admin/tournaments/list/[name]/ranking/speakers/_components/data-table";
import { tasks } from "@/app/(site)/admin/tournaments/list/[name]/ranking/speakers/data/tasks";
import { columns } from "@/app/(site)/admin/tournaments/list/[name]/ranking/speakers/_components/columns";
