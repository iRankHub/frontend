import { columns } from "@/app/(site)/admin/tournaments/list/[name]/ballots/preliminaries/_components/columns";
import { DataTable } from "@/app/(site)/admin/tournaments/list/[name]/ballots/preliminaries/_components/data-table";
import { tasks } from "@/app/(site)/admin/tournaments/list/[name]/ballots/preliminaries/data/tasks";
