...
const globalFilterFn: FilterFn<any> = (row, columnId, value, addMeta) => {
  ...
  const team1 = row.original.team1 as { name: string } | undefined;
  const team2 = row.original.team2 as { name: string } | undefined;
                          ...
                          {isPropositionOrOpposition ? (
                            editingRow === rowIndex ? (
                              ...
                              <Button
                                variant="outline"
                                className={cn(
                                  "w-full justify-between bg-transparent hover:bg-transparent cursor-default",
                                  `border ${borderColor}`
                                )}
                              >
                                {currentTeam}
