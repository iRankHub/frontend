            ...
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="relative border-none p-2">
                <div className="hidden md:flex flex-col items-end mr-2">
                  ...
                  <span className="text-xs text-[#637381]">School</span>
                </div>
      ...
      <DropdownMenuContent className="w-56" align="end" forceMount>
        ...
        <DropdownMenuGroup>
          <DropdownMenuItem className="hover:cursor-pointer" asChild>
            <Link href="/schools/dashboard" className="flex items-center">
              <LayoutGrid className="w-4 h-4 mr-3 text-muted-foreground" />
              Dashboard
            </Link>
          </DropdownMenuItem>
          <DropdownMenuItem className="hover:cursor-pointer" asChild>
            <Link href="/schools/profile" className="flex items-center">
